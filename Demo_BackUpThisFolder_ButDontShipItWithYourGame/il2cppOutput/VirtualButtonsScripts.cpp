...
IL_003b:
	{
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_17 = __this->___controller_7;
...
IL_00b7:
	{
		...
		PlayerActionsExample_t4427753BBD91C64E59E8AA33BEEF3B4A7D4C694E* L_30 = __this->___playerInput_8;
		NullCheck(L_30);
		PlayerActions_t48380AB459D9F557C5D50E2D6D52A17BA5CEE179 L_31;
		L_31 = PlayerActionsExample_get_Player_m815F883370E81D9C984631E3E58365D9568E48C1(L_30, NULL);
		V_2 = L_31;
		InputAction_t1B550AD2B55AF322AFB53CD28DA64081220D01CD* L_32;
		L_32 = PlayerActions_get_Jump_m9011E97546DDDB95DFCC2E5F8AD56B1607350CD5((&V_2), NULL);
		NullCheck(L_32);
		bool L_33;
		L_33 = InputAction_get_triggered_m27FD9FEF221D1BD365F2A8CD0131CE5F2A97B7BB(L_32, NULL);
	...
	{
		bool L_34 = __this->___groundedPlayer_10;
		if (!L_34)
		{
			goto IL_0100;
		}
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_35 = (&__this->___playerVelocity_9);
		float* L_36 = (&L_35->___y_3);
		float* L_37 = L_36;
		float L_38 = *((float*)L_37);
		float L_39 = __this->___jumpHeight_5;
		float L_40 = __this->___gravityValue_6;
		float L_41;
		L_41 = sqrtf(((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_39, (-3.0f))), L_40)));
...
IL_0100:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_42 = (&__this->___playerVelocity_9);
		float* L_43 = (&L_42->___y_3);
		float* L_44 = L_43;
		float L_45 = *((float*)L_44);
		float L_46 = __this->___gravityValue_6;
		float L_47;
		...
		*((float*)L_44) = (float)((float)il2cpp_codegen_add(L_45, ((float)il2cpp_codegen_multiply(L_46, L_47))));
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_48 = __this->___controller_7;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_49 = __this->___playerVelocity_9;
		float L_50;
